...
def _process_caption_data(caption_file, image_dir, max_length):
    '''
        return:
            pd.DataFrame with colums of caption(processed caption, lenght>max_length are droped), 
            file_name(full path of image), image_id
    '''
    ...
    # data is a list of dictionary which contains 'caption', 'file_name' and 'image_id' as key.
    data = []
    ...
    del_idx = []
    for i, caption in enumerate(caption_data['caption']): # str of caption
...
def _build_caption_vector(annotations, word_to_idx, max_length=15):
    '''
    convert caption of string to caption of word index
    '''
...
def main():
    ...
    #             hickle.dump(feats, save_path+'batch' + str(i)+'.hkl')
    #             i += 1
    #             all_feats[start:end, :] = feats
                

    #         use hickle to save huge feature vectors
    #         hickle.dump(all_feats, save_path, mode='w+')
